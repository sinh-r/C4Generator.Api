...
namespace C4Generator.Infrastructure.SourceControl.Bitbucket;

internal sealed class BitbucketSourceControlProvider : ISourceControlProvider
{
    public SourceControlProvider ProviderType => SourceControlProvider.Bitbucket;
    ...
    public Task<IReadOnlyList<SourceRepositoryInfo>> GetOrganizationRepositoriesAsync(
        ...
        => throw new NotImplementedException("Bitbucket provider is not yet supported.");
